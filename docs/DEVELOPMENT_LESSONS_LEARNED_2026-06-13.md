...
### **헌법 35 (2026-06-16): 「설정만 수정」 = 사장님 위험 사전 알림!**
> 사장님 EVAAUSDT #149 = 강제 50% 청산!
= 「↻ 설정만 수정」 클릭 시 = 위험 사전 confirm 모달 필수!

### **헌법 36 (2026-06-16): 「단계 확장」 = 청산 없이 = 자율!**
> 사장님 = 4, 5단계 신 추가 = 진입 보존!
= 옛 진입 단계 = 절대 보존!

### **헌법 37 (2026-06-16): Telegram 자동 재시도 영구!**
> 사장님 #162 = [send_error] HTTPSConnectionPool!
= 즉시 = 3회 retry + worker 매 5분!
= critical 알림 = 영구 보장!

### **헌법 38 (2026-06-16): TP 청산 % step_size 보정 = 정상!**
> ±10% 이하 = 정상 (= 사장님 이익!)
= ±10% 초과 = 사장님 인지!

### **헌법 39 (2026-06-16): UI 자동 새로고침 강화!**
> 사장님 0/10 캐시 silent bug!
= polling 강화 + JS version 자동 갱신!

### **헌법 28 추가 v2 (2026-06-14): 종료된 strategy = 시스템 영향 절대 X!**

> **사장님 명시 (2026-06-14):**
> **"전략 템플릿은 전략 인스턴스 종료하면 시스템에 영향을 줄수 없는데"**

= **모든 worker / 검증 / 자동 trigger = 종료된 strategy 무시!**
= STOPPED / COMPLETED / STOPPING / ARCHIVED = 자동 운영 영향 X!
= 옛 silent bug 패턴 (= self-check false positive) = 영구 차단!

### **헌법 29: 사장님 자율 청산 회피 = 100% 까지!**
```
사장님 사상:
