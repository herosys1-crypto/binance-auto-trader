...
class StrategyTemplate(Base):
    ...
    # 🚀 v118 (2026-07-22, alembic 0021): 사장님 TP20 확장!
    tp11_percent: Mapped[Decimal | None] = mapped_column(Numeric(8, 4), nullable=True)
    tp12_percent: Mapped[Decimal | None] = mapped_column(Numeric(8, 4), nullable=True)
    tp13_percent: Mapped[Decimal | None] = mapped_column(Numeric(8, 4), nullable=True)
    tp14_percent: Mapped[Decimal | None] = mapped_column(Numeric(8, 4), nullable=True)
    tp15_percent: Mapped[Decimal | None] = mapped_column(Numeric(8, 4), nullable=True)
    tp16_percent: Mapped[Decimal | None] = mapped_column(Numeric(8, 4), nullable=True)
    tp17_percent: Mapped[Decimal | None] = mapped_column(Numeric(8, 4), nullable=True)
    tp18_percent: Mapped[Decimal | None] = mapped_column(Numeric(8, 4), nullable=True)
    tp19_percent: Mapped[Decimal | None] = mapped_column(Numeric(8, 4), nullable=True)
    tp20_percent: Mapped[Decimal | None] = mapped_column(Numeric(8, 4), nullable=True)
    ...
    tp11_qty_ratio: Mapped[Decimal | None] = mapped_column(Numeric(8, 4), nullable=True)
    tp12_qty_ratio: Mapped[Decimal | None] = mapped_column(Numeric(8, 4), nullable=True)
    tp13_qty_ratio: Mapped[Decimal | None] = mapped_column(Numeric(8, 4), nullable=True)
    tp14_qty_ratio: Mapped[Decimal | None] = mapped_column(Numeric(8, 4), nullable=True)
    tp15_qty_ratio: Mapped[Decimal | None] = mapped_column(Numeric(8, 4), nullable=True)
    tp16_qty_ratio: Mapped[Decimal | None] = mapped_column(Numeric(8, 4), nullable=True)
    tp17_qty_ratio: Mapped[Decimal | None] = mapped_column(Numeric(8, 4), nullable=True)
    tp18_qty_ratio: Mapped[Decimal | None] = mapped_column(Numeric(8, 4), nullable=True)
    tp19_qty_ratio: Mapped[Decimal | None] = mapped_column(Numeric(8, 4), nullable=True)
